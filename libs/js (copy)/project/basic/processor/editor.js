...
//-            },
        ...
        var cbCustom = [];
        var basickeys = 'ENGINE,SYS,PAGE,window';
        
        map(parseLS(basickeys), function(bk) {
            cbCustom.add({value:bk, score:300, meta:'BASIC'});
            
            mapO(window[bk], function(v,k) {
                cbCustom.add({value:k, score:200, meta:bk});
                cbCustom.add({value:[bk,k].join('.'), score:100, meta:'BASIC'});
            });
        })
